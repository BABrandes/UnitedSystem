...
from typing import Generic, Any, Optional, TypeVar, Union, Sequence, Iterator, Callable, overload, Iterable, Type
...
class UnitedDataframeProtocol(Generic[CK, T]):
    ...
    _internal_dataframe_column_name_formatter: InternalDataFrameColumnNameFormatter[CK]
    ...
    def _row_set_ordered(self, row_index: int, values: Sequence[VALUE_TYPE]) -> None: ...
    ...
    def row_get_head(self, n: int = 5) -> Sequence[dict[CK, SCALAR_TYPE]]: ...
    def row_get_tail(self, n: int = 5) -> Sequence[dict[CK, SCALAR_TYPE]]: ...
    ...
    @classmethod
    def from_hdf5(cls, group: Union[h5py.Group, tuple[str, h5py.Group]], column_key_type: Type[CK], internal_dataframe_column_name_formatter: InternalDataFrameColumnNameFormatter[CK]=SimpleInternalDataFrameNameFormatter(), **kwargs: Any) -> "UnitedDataframe[CK]": ...
    @classmethod
    def from_json(cls, data: dict[str, Any], column_key_type: Type[CK], internal_dataframe_column_name_formatter: InternalDataFrameColumnNameFormatter[CK]=SimpleInternalDataFrameNameFormatter()) -> T: ...
    @classmethod
    ...
    @classmethod
    def create_empty(cls, column_keys: Sequence[CK], column_types: dict[CK, ColumnType], column_units_or_dimensions: dict[CK, Union[Unit, Dimension, None]], internal_dataframe_column_name_formatter: InternalDataFrameColumnNameFormatter[CK]=SimpleInternalDataFrameNameFormatter()) -> "UnitedDataframe[CK]": ...
    @classmethod
