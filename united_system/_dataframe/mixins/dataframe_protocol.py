...
class UnitedDataframeProtocol(Generic[CK, T]):
    ...
    @classmethod
    def create_from_data(cls, arrays: dict[CK, Union[ARRAY_TYPE, list[LOWLEVEL_TYPE]]], column_types: dict[CK, ColumnType], column_units_or_dimensions: dict[CK, Union[Unit, Dimension, None]], internal_dataframe_column_name_formatter: InternalDataFrameColumnNameFormatter) -> "UnitedDataframe[CK]": ...
    @classmethod
