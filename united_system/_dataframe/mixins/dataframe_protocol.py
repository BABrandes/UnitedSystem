...
class UnitedDataframeProtocol(Generic[CK, T]):
    ...
    @classmethod
    def from_hdf5(cls, group: Union[h5py.Group, tuple[str, h5py.Group]], internal_dataframe_column_name_formatter: InternalDataFrameColumnNameFormatter = SimpleInternalDataFrameNameFormatter(), **kwargs: Any) -> "UnitedDataframe[CK]": ...
    @classmethod
