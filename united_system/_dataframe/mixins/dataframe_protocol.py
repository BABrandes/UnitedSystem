...
from typing import Generic, Any, Optional, TypeVar, Union, Sequence, Iterator, Tuple, Callable, overload, Iterable
...
class UnitedDataframeProtocol(Generic[CK, T]):
    ...
    def _cell_set_value_or_scalar(self, row_index: int, column_key: CK, value: SCALAR_TYPE|VALUE_TYPE) -> None: ...
    ...
    def create_from_dataframe(
        ...
        deepcopy: bool = True,
        read_only: bool = False) -> "UnitedDataframe[CK]": ...
    @classmethod
    def create_from_pandas_with_correct_column_names(cls, pandas_dataframe: pd.DataFrame, internal_dataframe_column_name_formatter: InternalDataFrameColumnNameFormatter, deep_copy: bool) -> "UnitedDataframe[CK]": ...
    @classmethod
