...
class AccessorSetitemMixin(UnitedDataframeProtocol[CK, "UnitedDataframe[CK]"]):
    ...
    @overload
    def __setitem__(self, key: int, value: Mapping[CK, VALUE_TYPE] | Mapping[CK, SCALAR_TYPE]) -> None: ...
    @overload
    ...
    @overload
    def __setitem__(self, key: slice, value: Mapping[CK, VALUE_TYPE] | Mapping[CK, SCALAR_TYPE]) -> None: ...
    @overload
    def __setitem__(self, key: tuple[int, CK], value: VALUE_TYPE) -> None: ...
    @overload
    ...
    @overload
    def __setitem__(self, key: tuple[Sequence[CK], int], value: Mapping[CK, VALUE_TYPE] | Mapping[CK, SCALAR_TYPE]) -> None: ...
    @overload
    def __setitem__(self, key: tuple[int, Sequence[CK]], value: Mapping[CK, VALUE_TYPE] | Mapping[CK, SCALAR_TYPE]) -> None: ...
    @overload
    def __setitem__(self, key: tuple[Sequence[CK], slice], value: "UnitedDataframe[CK] | Mapping[CK, VALUE_TYPE] | Mapping[CK, SCALAR_TYPE]") -> None: ...
    @overload
    def __setitem__(self, key: tuple[slice, Sequence[CK]], value: "UnitedDataframe[CK] | Mapping[CK, VALUE_TYPE] | Mapping[CK, SCALAR_TYPE]") -> None: ...
