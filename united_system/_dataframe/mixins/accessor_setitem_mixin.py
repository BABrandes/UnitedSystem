...
class AccessorSetitemMixin(UnitedDataframeProtocol[CK, "UnitedDataframe[CK]"]):
    ...
    @overload
    def __setitem__(self, key: tuple[int, Sequence[CK]], value: dict[CK, VALUE_TYPE] | dict[CK, SCALAR_TYPE]) -> None: ...
    @overload
    def __setitem__(self, key: tuple[Sequence[CK], slice], value: "UnitedDataframe[CK] | dict[CK, VALUE_TYPE] | dict[CK, SCALAR_TYPE]") -> None: ...
    @overload
    def __setitem__(self, key: tuple[slice, Sequence[CK]], value: "UnitedDataframe[CK] | dict[CK, VALUE_TYPE] | dict[CK, SCALAR_TYPE]") -> None: ...
