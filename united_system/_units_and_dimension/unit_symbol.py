...
class UnitSymbol(Enum):
    ...
    PARTS_PER_MILLION = UnitSymbolInformation.create(     "parts per million",     "ppm",               NamedQuantity.FRACTION,                 symbol_tags={UNIT_SYMBOL_TAG.SI_DERIVED_UNIT},      factor=1e-6)
    PARTS_PER_BILLION = UnitSymbolInformation.create(     "parts per billion",     "ppb",               NamedQuantity.FRACTION,                 symbol_tags={UNIT_SYMBOL_TAG.SI_DERIVED_UNIT},      factor=1e-9)
    PARTS_PER_TRILLION = UnitSymbolInformation.create(    "parts per trillion",    "ppt",               NamedQuantity.FRACTION,                 symbol_tags={UNIT_SYMBOL_TAG.SI_DERIVED_UNIT},      factor=1e-12)
    PARTS_PER_QUADRILLION = UnitSymbolInformation.create( "parts per quadrillion", "ppq",               NamedQuantity.FRACTION,                 symbol_tags={UNIT_SYMBOL_TAG.SI_DERIVED_UNIT},      factor=1e-15)
    PERCENT = UnitSymbolInformation.create(               "percent",               "%",                 NamedQuantity.FRACTION,                 symbol_tags={UNIT_SYMBOL_TAG.SI_DERIVED_UNIT},      factor=0.01)
    PROMILLE = UnitSymbolInformation.create(              "promille",              "‰",                 NamedQuantity.FRACTION,                 symbol_tags={UNIT_SYMBOL_TAG.SI_DERIVED_UNIT},      factor=0.001)
