...
if TYPE_CHECKING:
    ...
    from ..column_type import ColumnType, NUMERIC_SCALAR_TYPE, ARRAY_TYPE, SCALAR_TYPE, ARRAY_TYPE, PANDAS_SERIES_TYPE, LOWLEVEL_TYPE
    ...
    from ..accessors._group_by import GroupBy # type: ignore
...
class UnitedDataframeProtocol(JSONable, HDF5able, Protocol, Generic[CK]):
    ...
    def _groupby(self, by: Any, sort: bool = True, dropna: bool = True): ...
    ...
    def _column_get_as_pd_series(self, column_key: CK, slice: slice|None = None) -> pd.Series[PANDAS_SERIES_TYPE]: ...
    ...
    @property
    def columns(self) -> List[CK]: ...
    @property
    def dtypes(self) -> Dict[CK, ColumnType]: ...
    @property
    ...
    def unit_set(self, column_key: CK, unit: Unit|None) -> None: ...

    # DimensionMixin user methods
    @property
    def dimensions(self) -> dict[CK, Optional[Dimension]]: ...
    def dimension_get(self, column_key: CK) -> Dimension: ...
    def dimension_has(self, column_key: CK) -> bool: ...
    ...
    def column_get_as_pd_series(self, column_key: CK, slice: slice|None = None) -> pd.Series[PANDAS_SERIES_TYPE]: ...
    ...
    def column_count_missing_values(self) -> dict[CK, int]: ...

    # RowOperationsMixin user methods
    def row_add(self, row_data: dict[CK, Any]) -> None: ...
    def row_remove(self, row_index_start_inclusive: int, row_index_stop_exclusive: int) -> None: ...
    def row_get(self, row_index: int, column_keys: list[CK]|None = None) -> dict[CK, Any]: ...
    def row_set(self, row_index: int, row_data: dict[CK, Any]) -> None: ...
    ...
    def cell_get(self, row_index: int, column_key: CK) -> SCALAR_TYPE: ...
    ...
    def mask_get_is_null(self, column_key: CK) -> BoolArray: ...
    def mask_get_is_not_null(self, column_key: CK) -> BoolArray: ...
    def mask_get_complete_rows(self) -> BoolArray: ...
    def mask_get_incomplete_rows(self) -> BoolArray: ...
    ...
    def iter_columns(self) -> Iterator[CK]: ...
    def iter_rows(self) -> Iterator[int]: ...
    def iter_units(self) -> Iterator[tuple[CK, Unit|None]]: ...
    def iter_dimensions(self) -> Iterator[tuple[CK, Dimension]]: ...
    def iter_coltypes(self) -> Iterator[tuple[CK, ColumnType]]: ...
    ...
    def slice_rows(self, start: int|None = None, stop: int|None = None, step: int|None = None) -> "UnitedDataframe[CK]": ...
    ...
    def filter_column_is_null(self, column_key: CK) -> "UnitedDataframe[CK]": ...
    def filter_column_is_not_null(self, column_key: CK) -> "UnitedDataframe[CK]": ...
    def filter_complete_cases(self) -> "UnitedDataframe[CK]": ...
