...
class NamedSimpleDimensionInformation():
    ...
    _canonical_unit: "Unit|None" = None
    ...
    def create(cls, dimension_exponents: Tuple[float, float, float, float, float, float, float], pseudo_dimension_exponents: Tuple[int, int], has_canonical_unit: bool, unit_string: str, tags: set[DimenensionTag] = set()) -> "NamedSimpleDimensionInformation":
        dimension: Dimension = Dimension.create(dimension_exponents, pseudo_dimension_exponents)
...
class NamedSimpleDimension(Enum):
    value: NamedSimpleDimensionInformation # type: ignore[assignment]
    ...
    @classmethod
    def has_named_canonical_dimension(cls, canonical_dimension: Dimension) -> bool:
    ...
    @classmethod
    def find_named_unit_dimension(cls, canonical_dimension: Dimension) -> "NamedSimpleDimension|None":
        for named_canonical_dimension in cls:
            if named_canonical_dimension.dimension == canonical_dimension:
                return named_canonical_dimension
        return None
