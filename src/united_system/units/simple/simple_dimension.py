...
_CANONICAL_UNIT_CACHE: dict["SimpleDimension", "SimpleUnit"] = {}

@dataclass(frozen=True, slots=True)
class SimpleDimension(BaseDimension["SimpleDimension", "SimpleUnit"]):
    dimension_exponents: Final[Tuple[float, float, float, float, float, float, float]]
    pseudo_dimension_exponents: Final[Tuple[int, int]]

    @classmethod
    def create(cls, dimension_exponents: Tuple[float, float, float, float, float, float, float]|list[float], pseudo_dimension_exponents: Tuple[int, int]|list[int]) -> "SimpleDimension":
    ...
    def __add__(self, other: "SimpleDimension") -> "SimpleDimension":
        return SimpleDimension((self.dimension_exponents[0] + other.dimension_exponents[0], self.dimension_exponents[1] + other.dimension_exponents[1], self.dimension_exponents[2] + other.dimension_exponents[2], self.dimension_exponents[3] + other.dimension_exponents[3], self.dimension_exponents[4] + other.dimension_exponents[4], self.dimension_exponents[5] + other.dimension_exponents[5], self.dimension_exponents[6] + other.dimension_exponents[6]),
    ...
    def __radd__(self, other: "SimpleDimension") -> "SimpleDimension":
        return self.__add__(other)

    def __sub__(self, other: "SimpleDimension") -> "SimpleDimension":
        return SimpleDimension((self.dimension_exponents[0] - other.dimension_exponents[0], self.dimension_exponents[1] - other.dimension_exponents[1], self.dimension_exponents[2] - other.dimension_exponents[2], self.dimension_exponents[3] - other.dimension_exponents[3], self.dimension_exponents[4] - other.dimension_exponents[4], self.dimension_exponents[5] - other.dimension_exponents[5], self.dimension_exponents[6] - other.dimension_exponents[6]),
                                  (self.pseudo_dimension_exponents[0] - other.pseudo_dimension_exponents[0], self.pseudo_dimension_exponents[1] - other.pseudo_dimension_exponents[1]))

    def __rsub__(self, other: "SimpleDimension") -> "SimpleDimension":
        return SimpleDimension((other.dimension_exponents[0] - self.dimension_exponents[0], other.dimension_exponents[1] - self.dimension_exponents[1], other.dimension_exponents[2] - self.dimension_exponents[2], other.dimension_exponents[3] - self.dimension_exponents[3], other.dimension_exponents[4] - self.dimension_exponents[4], other.dimension_exponents[5] - self.dimension_exponents[5], other.dimension_exponents[6] - self.dimension_exponents[6]),
    ...
    def __mul__(self, other: float) -> "SimpleDimension":
        return SimpleDimension((self.dimension_exponents[0] * other, self.dimension_exponents[1] * other, self.dimension_exponents[2] * other, self.dimension_exponents[3] * other, self.dimension_exponents[4] * other, self.dimension_exponents[5] * other, self.dimension_exponents[6] * other),
                                  (int(self.pseudo_dimension_exponents[0] * other), int(self.pseudo_dimension_exponents[1] * other)))

    def __truediv__(self, other: float) -> "SimpleDimension":
        return SimpleDimension((self.dimension_exponents[0] / other, self.dimension_exponents[1] / other, self.dimension_exponents[2] / other, self.dimension_exponents[3] / other, self.dimension_exponents[4] / other, self.dimension_exponents[5] / other, self.dimension_exponents[6] / other),
                                  (int(self.pseudo_dimension_exponents[0] / other), int(self.pseudo_dimension_exponents[1] / other)))

    def __eq__(self, other: "SimpleDimension") -> bool:
    ...
    def __ne__(self, other: "SimpleDimension") -> bool:
    ...
    def canonical_unit(self) -> "SimpleUnit":
        ...
        # Import here to avoid circular imports
        from .simple_unit import SimpleUnit
        from ..named_simple_dimensions import NamedSimpleDimension, DimenensionTag
        
        # If this is a dimensionless quantity, return empty unit
        if self.is_zero():
            result = SimpleUnit.create_empty()
            _CANONICAL_UNIT_CACHE[self] = result
            return result
        
        # First check if there's a named dimension that matches exactly
        named_dimension = NamedSimpleDimension.find_named_unit_dimension(self)
        if named_dimension is not None:
            result = named_dimension.canonical_unit
            _CANONICAL_UNIT_CACHE[self] = result
            return result
        
        # If no exact match, build from base dimensions
        base_dimensions = NamedSimpleDimension.unit_dimensions_by_tags({DimenensionTag.BASE_DIMENSION})
        
        unit_string_parts = []
        current_dimension_exponents = list(self.dimension_exponents)
        current_pseudo_dimension_exponents = list(self.pseudo_dimension_exponents)
        ...
        result = SimpleUnit.parse_string(unit_string)
        _CANONICAL_UNIT_CACHE[self] = result
        return result
    ...
    @classmethod
    def from_json(cls, json: dict) -> "SimpleDimension":
        unit = SimpleUnit.from_json(json)
        return cls(unit.dimension.dimension_exponents, unit.dimension.pseudo_dimension_exponents)

    def compatible_to(self, other: "SimpleDimension") -> bool:
    ...
    @classmethod
    def from_hdf5(cls, hdf5_group: h5py.Group) -> "SimpleDimension":
        unit = SimpleUnit.from_hdf5(hdf5_group)
        return cls(unit.dimension.dimension_exponents, unit.dimension.pseudo_dimension_exponents)

@dataclass(frozen=True, slots=True)
class Subscripted_Canonical_Dimension(BaseDimension):
