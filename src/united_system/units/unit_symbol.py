...
class UnitSymbolInformation():
    ...
    @classmethod
    def create(cls, name: str, symbol: Union[str, list[str]], named_canonical_quantity: NamedSimpleUnitQuantity, symbol_tags: set[UnitSymbolTag], factor: float=1, offset: float=0) -> "UnitSymbolInformation":
        return cls(name, [symbol] if isinstance(symbol, str) else symbol, named_canonical_quantity, symbol_tags, factor, offset)
...
class UnitSymbol(Enum):
    ...
    DAY = UnitSymbolInformation.create(                   "day",                   "days",              NamedSimpleUnitQuantity.TIME,                    symbol_tags={UnitSymbolTag.NON_SI_SYSTEM}, factor=86400)
    ...
    TESLA = UnitSymbolInformation.create(                 "tesla",                 "T",                 NamedSimpleUnitQuantity.MAGNETIC_FLUX_DENSITY,   symbol_tags={UnitSymbolTag.SI_DERIVED_UNIT})
    ...
    HOUR = UnitSymbolInformation.create(                  "hour",                  "h",                 NamedSimpleUnitQuantity.TIME,                    symbol_tags={UnitSymbolTag.NON_SI_SYSTEM}, factor=3600)
    ...
    MINUTE = UnitSymbolInformation.create(                "minute",                "min",               NamedSimpleUnitQuantity.TIME,                    symbol_tags={UnitSymbolTag.NON_SI_SYSTEM}, factor=60)
    ...
    OHM = UnitSymbolInformation.create(                   "ohm",                   ["Ω", "Ω", "Ohm"],   NamedSimpleUnitQuantity.RESISTANCE,              symbol_tags={UnitSymbolTag.SI_DERIVED_UNIT})
    ...
    WEEK = UnitSymbolInformation.create(                  "week",                  "weeks",             NamedSimpleUnitQuantity.TIME,                    symbol_tags={UnitSymbolTag.NON_SI_SYSTEM}, factor=604800)
    MONTH = UnitSymbolInformation.create(                 "month",                 "months",            NamedSimpleUnitQuantity.TIME,                    symbol_tags={UnitSymbolTag.NON_SI_SYSTEM}, factor=2629746)
    YEAR = UnitSymbolInformation.create(                  "year",                  "years",             NamedSimpleUnitQuantity.TIME,                    symbol_tags={UnitSymbolTag.NON_SI_SYSTEM}, factor=31556952)
    ...
    def __getitem__(self, symbol: str) -> "UnitSymbol":
        result: Union[UnitSymbol, None] = self.find_unit_symbol(symbol)
        if result is None:
    ...
    @staticmethod
    def find_unit_symbol(symbol: str) -> Union["UnitSymbol", None]:
