...
class IntArray(JSONable, HDF5able):
    ...
    # Factory methods
    @classmethod
    def from_values(cls, values: Union[np.ndarray, list]) -> "IntArray":
        """Create an IntArray from values."""
        return cls(values)
    
    @classmethod
    def zeros(cls, shape: Union[int, tuple]) -> "IntArray":
        """Create an array of zeros."""
        return cls(np.zeros(shape, dtype=int))
    
    @classmethod
    def ones(cls, shape: Union[int, tuple]) -> "IntArray":
        """Create an array of ones."""
        return cls(np.ones(shape, dtype=int))
    
    @classmethod
    def full(cls, shape: Union[int, tuple], fill_value: int) -> "IntArray":
    ...
    # Comparison methods
    def __eq__(self, other: Union["IntArray", int]) -> np.ndarray:
    ...
    def __ne__(self, other: Union["IntArray", int]) -> np.ndarray:
    ...
    @classmethod
    def from_json(cls, data: dict) -> "IntArray":
        """Create from JSON dictionary."""
        return cls(InternalIntArray.from_json(data))
    ...
    @classmethod
    def from_hdf5(cls, hdf5_group: h5py.Group) -> "IntArray":
        """Create from HDF5 group."""
        return cls(InternalIntArray.from_hdf5(hdf5_group))
