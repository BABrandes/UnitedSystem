...
from typing import Union, Optional, Any, List, Sized
import numpy as np
import pandas as pd
from datetime import datetime, timedelta
import h5py
from pandas import Timestamp
from ..united_system.timestamp_array import TimestampArray as InternalTimestampArray
from ..united_system.utils.general import JSONable, HDF5able
from .bool_array import BoolArray

@dataclass(frozen=True, slots=True, init=False)
class TimestampArray(JSONable, HDF5able, Sized):
    ...
    def __init__(self, values: Union[np.ndarray[Any, Any], list[Any], InternalTimestampArray, pd.DatetimeIndex]):
        """
        ...
        match values:
            ...
            case np.ndarray() | list():
                ...
                elif isinstance(values, np.ndarray[Any, Any]):
    ...
    def __getitem__(self, index_or_slice: Union[int, slice]) -> Union[Timestamp, "TimestampArray"]:
        ...
        result: Union[Timestamp, InternalTimestampArray] = self._wrapped_array[index_or_slice]
    ...
    def __ne__(self, other: object) -> "BoolArray":
    ...
    @classmethod
    def from_values(cls, values: Union[np.ndarray[Any, Any], list[Any]]) -> "TimestampArray":
        """Create from values."""
        return cls(values)
    ...
    @classmethod
    def from_json(cls, data: dict[str, Any], **_: Any) -> "TimestampArray":
        """Create from JSON dictionary."""
        return cls(InternalTimestampArray.from_json(data)) # type: ignore
    ...
    @classmethod
    def from_hdf5(cls, hdf5_group: h5py.Group, **_: Any) -> "TimestampArray":
        """Create from HDF5 group."""
        return cls(InternalTimestampArray.from_hdf5(hdf5_group)) # type: ignore