...
from typing import Union, TYPE_CHECKING, Optional, Any, Type
...
class RealUnitedScalar(JSONable, HDF5able, United[Dimension, Unit]):
...
########################################################
    ...
    def display_unit(self) -> Optional[Unit]:
        if self._display_unit is None and self._wrapped_real_scalar.display_unit is not None: # type: ignore
            object.__setattr__(self, "_display_unit", Unit(self._wrapped_real_scalar.display_unit))
        return self._display_unit
    
    @property
    def active_unit(self) -> Unit:
        if self._wrapped_real_scalar._display_unit is not None: # type: ignore
            return self._wrapped_real_scalar.display_unit # type: ignore
        else:
...
########################################################
    ...
    def __repr__(self) -> str:
        ...
        return f"RealUnitedScalar({self._wrapped_real_scalar!r})"
    ...
    @classmethod
    def from_json(cls, data: dict[str, Any], **_: Type[Any]) -> "RealUnitedScalar":
        return cls(InternalRealUnitedScalar.from_json(data, **_))
    ...
    @classmethod
    def from_hdf5(cls, hdf5_group: h5py.Group, **_: Type[Any]) -> "RealUnitedScalar":
        return cls(InternalRealUnitedScalar.from_hdf5(hdf5_group, **_))