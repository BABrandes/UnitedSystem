...
from ..united_system.named_dimensions import NamedDimension, DimensionExponents
from ..united_system.units.simple.simple_dimension import SimpleDimension
from ..united_system.units.base_classes.base_dimension import BaseDimension
import h5py
...
class Dimension(JSONable, HDF5able, BaseDimension["Dimension", Unit]):
