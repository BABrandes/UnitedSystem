...
from ..united_system.units.base_classes.base_unit import BaseUnit
...
class Unit(JSONable, HDF5able, BaseUnit[Dimension, "Unit"]):
...
########################################################
    ...
    _wrapped_unit: Unit = field(init=False, compare=False)
...
########################################################
    ...
    def __init__(self, unit_or_dimension: Union[str, Unit, Dimension]):
        """
        ...
        match unit_or_dimension:
            ...
            case str():
                object.__setattr__(self, "_wrapped_unit", Unit.parse_string(unit_or_dimension))

            case Dimension():
                object.__setattr__(self, "_wrapped_unit", Unit.parse_string(unit_or_dimension.canonical_unit.format_string(no_fraction=False)))
...
########################################################
    ...
    def to_canonical_value(self, value: complex) -> complex:
        ...
        ...
    @overload
    def to_canonical_value(self, values: np.ndarray) -> np.ndarray:
        """Convert values from this unit to canonical units."""
        ...
    def to_canonical_value(self, value: Union[float, int, complex, np.ndarray]) -> Union[float, int, complex, np.ndarray]:
        """Convert a value from this unit to canonical units."""
    ...
    def from_canonical_value(self, canonical_value: complex) -> complex:
        ...
        ...
    @overload
    def from_canonical_value(self, canonical_values: np.ndarray) -> np.ndarray:
        """Convert values from canonical units to this unit."""
        ...
    ...
    @overload
    @staticmethod
    def convert(value: Union[float, int], old_unit: "Unit", new_unit: "Unit") -> float:
        """Convert a value from one unit to another."""
        ...
    @overload
    @staticmethod
    def convert(value: complex, old_unit: "Unit", new_unit: "Unit") -> complex:
        """Convert a value from one unit to another."""
        ...
    @overload
    @staticmethod
    def convert(values: np.ndarray, old_unit: "Unit", new_unit: "Unit") -> np.ndarray:
        """Convert values from one unit to another."""
        ...
    @staticmethod
    def convert(value: Union[float, int, complex, np.ndarray], old_unit: "Unit", new_unit: "Unit") -> Union[float, int, complex, np.ndarray]:
        """Convert a value from one unit to another."""
        return new_unit.from_canonical_value(old_unit.to_canonical_value(value))
    ...
    def parse_string(cls, unit_str: str) -> "Unit":
        ...
        return cls(Unit.parse_string(unit_str))
...
########################################################
    ...
    def suggest_units(cls, dimension: Dimension, canonical_value: Union[float, int, None] = None, n: int = 10) -> list["Unit"]:
        ...
        """
        best_unit, alternatives = Unit.suggest_units(dimension, canonical_value, n=n)
...
########################################################
    ...
    def from_json(cls, data: dict) -> "Unit":
        ...
        return cls(Unit.from_json(data))
    ...
    def from_hdf5(cls, hdf5_group: h5py.Group) -> "Unit":
        ...
        return cls(Unit.from_hdf5(hdf5_group))
