...
from ..united_system.string_array import StringArray as InternalStringArray

@dataclass(frozen=True, slots=True, init=False)
class StringArray(JSONable, HDF5able, Sized):
    ...
    def __init__(self, values: Union[np.ndarray[Any, Any], list[Any], InternalStringArray]):
        """
        ...
        match values:
            ...
            case np.ndarray() | list():
                ...
                if values.ndim != 1:
                    raise ValueError("StringArray must be 1-dimensional")
    ...
    # Factory methods
    @classmethod
    def from_values(cls, values: Union[np.ndarray[Any, Any], list[Any]]) -> "StringArray":
        """Create a StringArray from values."""
        return cls(values)
    
    @classmethod
    def empty(cls, shape: Union[int, tuple[int, ...]]) -> "StringArray":
        """Create an empty string array."""
        return cls(np.empty(shape, dtype=str))
    
    @classmethod
    def full(cls, shape: Union[int, tuple[int, ...]], fill_value: str) -> "StringArray":
    ...
    @classmethod
    def from_json(cls, data: dict[str, Any], **_: Any) -> "StringArray":
        """Create from JSON dictionary."""
        return cls(InternalStringArray.from_json(data)) # type: ignore
    ...
    @classmethod
    def from_hdf5(cls, hdf5_group: h5py.Group, **_: Any) -> "StringArray":
        """Create from HDF5 group."""
        return cls(InternalStringArray.from_hdf5(hdf5_group)) # type: ignore
